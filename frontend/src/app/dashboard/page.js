    ...
    <Layout>
      <div className="w-full flex-1 flex flex-col bg-[#f8fafc] overflow-hidden h-full">
        ...
        <div className="page-body overflow-y-auto flex-1 space-y-6 py-8">
          ...
          <section className="bg-white rounded-2xl border border-border-custom p-6 md:p-8 text-left shadow-xs mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div 
                onClick={() => setIsModalOpen(true)}
                className="border border-border-custom p-5 rounded-xl hover:border-green-pri hover:-translate-y-0.5 hover:shadow-xs transition-all cursor-pointer text-left bg-grey-bg/25"
              >
